...
# REAMINING CHANGES REQUIRED HERE

- Further citations in second section
- Talk about ecosystem in is eyetrackr for you section
- brm cheap tracker paper you reviewed.
- this version of the guide is out of date for some bizarre reason. save this file and copy it back through
...
## Data from other Eye-trackers

I'm no stranger to using eye-trackers other than SR-Research's Eyelink trackers[@Riggs2018:1], even if it means building one from scratch. However, I'm also of the view that just because you can buy a tracker now for $50, or set someone's front-facing camera on their phone to work as an eye-tracker, that doesn't mean the data is of any value to you as a researcher. Saying that, I'm more than aware of the value of different types of equipment for different situations, such as using cheaper trackers as a teaching tool and the like! 

For now, both for consistency and for data quality, eyeTrackR will focus on one type of tracker only, but the underpinnings and framework for how it operates should be relatively easy to move over to other formats in the future.
